<template>
  <div>
    <a
      href="#"
      class="block transition duration-150 ease-in-out bg-white shadow sm:rounded-md hover:bg-gray-50 focus:outline-none focus:bg-gray-50"
    >
        ...
        <div class="mt-2">
          <div class="sm:flex">
            ...
            <div class="flex items-center mt-2 text-sm leading-5 text-gray-500">
              ...
              {{ school.min_age }} - {{ school.max_age }} years old
            </div>
          </div>
          <div class="flex items-center mt-2 text-sm leading-5 text-gray-500">
            <svg
